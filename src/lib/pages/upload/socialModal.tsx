                ...
                <ModalBody>
                    <VStack spacing={6} align="stretch">
                        <Flex gap={2} marginTop={"5%"} wrap="wrap" justify="center">
                            <Button onClick={handleShareTwitter} border={"1px solid white"} colorScheme="black" leftIcon={<FaXTwitter />} size="sm">Twitter</Button>
                            <Button onClick={handleShareWarpCast} color={"purple"} leftIcon={<Image src='/assets/warpcast.png' boxSize="20px" />} size="sm">Warpcast</Button>
